...
if ! command -v doggo; then
    ...
    echo "Arch: yay -S doggo-bin"
    echo "macOS: brew install doggo"
    echo "Windows: scoop install doggo"
    echo "source: go install github.com/mr-karan/doggo/cmd/doggo@latest"
    exit
fi
